...
# cks-master
sudo -i
bash <(curl -s https://raw.githubusercontent.com/bailey-t/cks-course-environment/master/cluster-setup/latest/install_master.sh)


# cks-worker
sudo -i
bash <(curl -s https://raw.githubusercontent.com/bailey-t/cks-course-environment/master/cluster-setup/latest/install_worker.sh)
...
```
https://github.com/bailey-t/cks-course-environment/tree/master/course-content/cluster-setup/network-policies/default-deny

---------------------------------------------------------------------------

https://github.com/bailey-t/cks-course-environment/tree/master/course-content/cluster-setup/network-policies/frontend-backend

---------------------------------------------------------------------------

https://github.com/bailey-t/cks-course-environment/tree/master/course-content/cluster-setup/network-policies/frontend-backend-database
...
kubectl apply -f https://raw.githubusercontent.com/bailey-t/cks-course-environment/master/course-content/cluster-setup/secure-ingress/nginx-ingress-controller.yaml

# Complete Example
https://github.com/bailey-t/cks-course-environment/tree/master/course-content/cluster-setup/secure-ingress
...
https://github.com/bailey-t/cks-course-environment/tree/master/course-content/cluster-setup/protect-node-metadata
```
...
```
# master
bash <(curl -s https://raw.githubusercontent.com/bailey-t/cks-course-environment/master/cluster-setup/previous/install_master.sh)

# worker
bash <(curl -s https://raw.githubusercontent.com/bailey-t/cks-course-environment/master/cluster-setup/previous/install_worker.sh)
...
https://github.com/bailey-t/cks-course-environment/blob/master/course-content/microservice-vulnerabilities/container-runtimes/gvisor/example.yaml
...
bash <(curl -s https://raw.githubusercontent.com/bailey-t/cks-course-environment/master/course-content/microservice-vulnerabilities/container-runtimes/gvisor/install_gvisor.sh)
...
```
kubectl create -f https://raw.githubusercontent.com/bailey-t/cks-course-environment/master/course-content/opa/gatekeeper.yaml

---------------------------------------------------------------------------

https://github.com/bailey-t/cks-course-environment/tree/master/course-content/opa/deny-all

---------------------------------------------------------------------------

https://github.com/bailey-t/cks-course-environment/tree/master/course-content/opa/namespace-labels

---------------------------------------------------------------------------

https://github.com/bailey-t/cks-course-environment/tree/master/course-content/opa/deployment-replica-count
...
```
https://github.com/bailey-t/cks-course-environment/tree/master/course-content/supply-chain-security/image-footprint
...
git clone https://github.com/bailey-t/cks-course-environment.git
...
# opa resources
https://github.com/bailey-t/cks-course-environment/tree/master/course-content/supply-chain-security/secure-the-supply-chain/whitelist-registries/opa
...
```
https://github.com/bailey-t/cks-course-environment/tree/master/course-content/runtime-security/auditing
...
```angular2html
# apparmor profile
https://github.com/bailey-t/cks-course-environment/blob/master/course-content/system-hardening/kernel-hardening-tools/apparmor/profile-docker-nginx
...
https://github.com/bailey-t/cks-course-environment/blob/master/course-content/system-hardening/kernel-hardening-tools/seccomp/profile-docker-nginx.json
